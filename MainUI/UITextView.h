...
////////////////////////////////////////////////////////////////////////////
// CUITextView class declaration

//	CUITextView::FindText() flags
enum
{
...
class AFX_EXT_CLASS CUITextView : public CView
{
	DECLARE_DYNCREATE(CUITextView)
...
protected:
	...
	virtual void OnUpdateSibling(CUITextView *pUpdateSource, BOOL bHorz);
	CUITextView *GetSiblingView(int nRow, int nCol);
...
public:
	...
	enum COLORINDEX
	{
		...
		COLORINDEX_BKGND,
		COLORINDEX_LINE_BKGND,
		COLORINDEX_SEPA_LINE,
		COLORINDEX_SEPA_LINE_NO,
		COLORINDEX_NORMALTEXT,
		COLORINDEX_SELMARGIN,
		COLORINDEX_SELBKGND,
		COLORINDEX_KILLFOCUS_SELBKGND,
		COLORINDEX_SELTEXT,
		//	Syntax colors
		COLORINDEX_TYPE,
		COLORINDEX_KEYWORD,
	...
	// Operations
public:
	void AttachToBuffer(CUITextBuffer *pBuf = NULL);
